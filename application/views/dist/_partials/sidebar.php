      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo $this->uri->segment(2) == 'index' || $this->uri->segment(2) == 'index_0' ? 'active' : '' ; ?>">
            ...
            <li class="menu-header">Menu Sistem</li>
            <li class="dropdown <?php echo  $this->uri->segment(1) == 'aplikasi' || $this->uri->segment(1) == 'aplikasi' ? 'active' : '' ; ?>">
              ...
              <ul class="dropdown-menu">
                <li class="<?php echo $this->uri->segment(1) == 'aplikasi' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>aplikasi">Aplikasi</a></li>
                <li class="<?php echo $this->uri->segment(1) == 'admin' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin">Admin</a></li>
              </ul>
            </li>
