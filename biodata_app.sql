...
CREATE TABLE `tb_jabatan` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `tb_jabatan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4;

/*Data for the table `tb_jabatan` */

insert  into `tb_jabatan`(`id`,`id_user`,`jabatan`,`eselon`,`tmt_jabatan`) values (16,1,'fighter','epic','2021-08-27'),(17,49,'kolonel','vi','2021-08-28'),(18,49,'2349023940','v','2021-08-28'),(19,58,'768686','898989','2021-08-02');
...
CREATE TABLE `tb_log_notif` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `tb_log_notif_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tb_user` (`id`)
